...
class YaUploader:
    ...
    def upload(self, folder_name, file_name, file_path, file_size):
...
if __name__ == '__main__':
    ...
    for photo in photos_list:
        ...
        result = uploader.upload(folder_name, file_name, files_path, file_size)
